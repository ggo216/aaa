...
const LAB_TREES = {
  atk_single: [
    ...
    passiveNode('leafB', '추가 타격', 'multislash', 'extraAtkChance', 1.0, 'branchB', 3),
  ...
  atk_multi: [
    ...
    passiveNode('leafB', '유혈', 'debuff', 'dotChance', 1.5, 'branchB', 3),
  ...
  magic_multi: [
    ...
    passiveNode('leafA', '화염 낙인', 'debuff', 'dotChance', 1.5, 'branchA', 3),
  ...
  magic_ctrl: [
    ...
    passiveNode('leafB', '동상', 'debuff', 'dotChance', 1.5, 'branchB', 3),
  ...
  ranged_single: [
    ...
    passiveNode('leafB', '이중 사격', 'arrow', 'extraAtkChance', 1.0, 'branchB', 3),
  ...
  buff_debuff: [
    ...
    passiveNode('leafA', '역병', 'debuff', 'dotChance', 1.8, 'branchA', 3),
